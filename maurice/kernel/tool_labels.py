...
TOOL_ACTION_LABELS: dict[str, str] = {
    ...
    "self_update.report_bug": "signaler un bug Maurice",
    "host.service_status": "consulter l'état du service Maurice",
    "host.status": "consulter l'état du service Maurice",
    "host.doctor": "diagnostiquer Maurice",
    "host.events_tail": "lire les derniers événements Maurice",
    "host.logs": "lire les derniers événements Maurice",
